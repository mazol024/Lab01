...
var SampleValidator = (function () {
    ...
    function checkDeliveryPostcode (deliveryPostcode, messages) {
        if (!checkNotEmpty(deliveryPostcode)) {
            messages.push("Delivery Postcode must not be empty");
        } else if (!checkLength(deliveryPostcode,4,4)){
            messages.push("Delivery Postcode must be 4 digits length");
        }
    }
    ...
    function validateCheckout() {
        ...
        var deliveryName, deliveryAddress1, deliveryCity, deliveryEmail, deliveryPostcode;
